    ...
    static partial class VisualElementExtensions
    {
        ...
        internal static StyleSheet DarkStyle
        {
            get
            {
                if (_darkStyle == null)
                {
                    _darkStyle = Resources.Load<StyleSheet>("_tweening/_style");
                }
                return _darkStyle;
            }
        }
        ...
        internal static StyleSheet LightStyle
        {
            get
            {
                if (_lightStyle == null)
                {
                    _lightStyle = Resources.Load<StyleSheet>("_tweening/_style_lite");
                }
                return _lightStyle;
            }
        }
        ...
        public static T AddTweensStyle<T>(this T element) where T : VisualElement
        {
        ...
        public static T RemoveTweensStyle<T>(this T element) where T : VisualElement
        {
