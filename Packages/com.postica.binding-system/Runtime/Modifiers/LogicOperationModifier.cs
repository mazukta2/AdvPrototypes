...
namespace Postica.BindingSystem.Modifiers
{
    ...
    [Serializable]
    [HideMember]
    [TypeDescription("Performs a logic operation on the input boolean value.")]
    public sealed class LogicOperationModifier : BaseModifier<bool>, IDynamicComponent
    {
        ...
        public bool IsDynamic => _operand.IsBound;
