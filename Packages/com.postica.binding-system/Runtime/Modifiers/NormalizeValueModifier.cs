...
namespace Postica.BindingSystem.Modifiers
{
    ...
    [Serializable]
    [HideMember]
    [TypeDescription("Normalizes the input float value between min and max.")]
    public sealed class NormalizeValueModifier : BaseModifier<float>, IReadWriteModifier<double>, IDynamicComponent
    {
        [SerializeField]
        ...
        public bool IsDynamic => min.IsBound || max.IsBound;
    }
}